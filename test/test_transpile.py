...
def zipy(uncompressed_string):
    ...
    def string_to_zip(filename: str, strk: str) -> None:
        ...
        dos_time = (
            (mod_time.tm_year - 1980) << 9 | mod_time.tm_mon << 5 | mod_time.tm_mday
        )
        ...
        open("sample.zip", "wb").write(zip_content)
        return zip_content
...
def test_transform_zipy():
    uncompressed_string = """"Did you win your sword fight?"
            "Of course I won the fucking sword fight," Hiro says. "I'm the greatest sword fighter in the world."
            "And you wrote the software."
            "Yeah. That, too," Hiro says.",
        """
    transpiled_function_object(zipy, debug=True)(uncompressed_string)
    import zipfile
